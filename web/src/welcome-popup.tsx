...
export function WelcomePopup({ acceptedPopupCallback }) {
    ...
    return (
        <div className="h-screen w-screen bg-transparent absolute" onClick={acceptedPopup}>
            <div
                className="z-50 relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-xl"
                onClick={(evt) => {
                    evt.stopPropagation();
                }}
            >
                ...
                <div className={`relative ${BG_WHITE_COLOR} rounded-lg shadow mx-5`}>
                    ...
                    <div className="p-6 space-y-6 text-gray-500">
                        ...
                        <p>
                            ...
                            colour-coded by how far and how quickly you can travel from that point.
                            Explore around to see how transit-accessible different parts of your
                            city are!
                        </p>
                        <p>
                            Hover/click over any other point to view the route you must take to
                            arrive their from your previously selected origin.
                        </p>
                    </div>
                    {/* Modal footer */}
