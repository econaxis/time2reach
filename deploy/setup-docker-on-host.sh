...
docker run --name main -d -p 443:3030 -v $HOME/data2:/app:rw -e RUST_LOG=info,timetoreach=debug,h2=info,hyper=info,warp=info,rustls=info ghcr.io/econaxis/test:latest
